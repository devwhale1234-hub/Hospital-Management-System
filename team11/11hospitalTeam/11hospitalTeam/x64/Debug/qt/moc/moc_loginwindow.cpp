...
template <> constexpr inline auto LoginWindow::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "LoginWindow",
        "onAdminPortalClicked",
        "",
        "onDoctorPortalClicked",
        "onPatientPortalClicked",
        "onPortalClosed"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'onAdminPortalClicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onDoctorPortalClicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onPatientPortalClicked'
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onAdminPortalClicked(); break;
        case 1: _t->onDoctorPortalClicked(); break;
        case 2: _t->onPatientPortalClicked(); break;
        case 3: _t->onPortalClosed(); break;
        default: ;
        }
    }
    (void)_a;
